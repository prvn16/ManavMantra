###########################################################################
## Makefile generated for Simulink model 'cgen_fi'. 
## 
## Makefile     : cgen_fi.mk
## Generated on : Thu Apr 26 13:33:06 2018
## MATLAB Coder version: 4.0 (R2018a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\cgen_fi.exe
...
MODELREF_LINK_RSPFILE_NAME = cgen_fi_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = cgen_fi_ref.rsp
CMD_FILE                  = cgen_fi.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\cgen_fi.exe
...
INCLUDES_BUILDINFO = $(START_DIR);$(START_DIR)\cgen_fi_grt_rtw;$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common
...
DEFINES_STANDARD = -DMODEL=cgen_fi -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)\rtw\c\src\rt_logging.c $(START_DIR)\cgen_fi_grt_rtw\cgen_fi.c $(START_DIR)\cgen_fi_grt_rtw\cgen_fi_data.c $(START_DIR)\cgen_fi_grt_rtw\rtGetInf.c $(START_DIR)\cgen_fi_grt_rtw\rtGetNaN.c $(START_DIR)\cgen_fi_grt_rtw\rt_nonfinite.c
...
OBJS = rt_logging.obj cgen_fi.obj cgen_fi_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj
...
{$(START_DIR)\cgen_fi_grt_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\cgen_fi_grt_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
