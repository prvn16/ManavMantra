...
%SET Set property values of fimath object
%   Set the property 'PropertyName' of the fimath object A is not allowed.
%
%   B = SET(A) displays all visible properties with public set access 
%              of fimath object A in a scalar structure.
...
elseif nargin == 2
    ...
    error(message('fixed:embedded:setInvalidUse', 'FIMATH'));
end
