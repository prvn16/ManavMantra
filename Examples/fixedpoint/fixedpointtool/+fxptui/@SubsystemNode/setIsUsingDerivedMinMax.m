function setIsUsingDerivedMinMax(hDlg, hTag, source) 
...
oldval = appData.AutoscalerProposalSettings.isUsingDerivedMinMax;

if isempty(val)
    boolIsUsingDerivedMinMax = oldval;
else
    
    boolIsUsingDerivedMinMax = (val == 1);
end


appData.AutoscalerProposalSettings.isUsingDerivedMinMax = boolIsUsingDerivedMinMax;
end
