function setProposeForFloatingPoint(hDlg, hTag, ~) 
...
oldval = propSettings.ProposeForFloatingPoint;

try 
    propSettings.ProposeForFloatingPoint = logical(val);
catch e
    propSettings.ProposeForFloatingPoint = oldval;
