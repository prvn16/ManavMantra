...
%FIR_FILT_CIRC_BUFF_TYPED_CODEGEN Finite impulse response filter with circular buffer
%
%    [y,z,p] = fir_filt_circ_buff_typed_codegen(b,x,z,p,T) filters the data in
...
%
%     %% Call the filter
%     [y,z,p] = fir_filt_circ_buff_typed_codegen(b,x,z,p,T);
%
%     %% Plot
%     clf
%     plot(t,x,t,y)
