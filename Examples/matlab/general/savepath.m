...
try
    ...
    fulluserpath = regexp([userpath() pathsep getenv('MATLABPATH') pathsep], DelimitedByAndIncludingSep, 'tokens');
    fulluserpath = [fulluserpath{:}]';
    fulluserpath = [fulluserpath; {[fullfile(tempdir, 'Editor') ps]}; {[fullfile(prefdir, 'Editor') ps]}];
