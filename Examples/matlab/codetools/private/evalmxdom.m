...
% Tell graphics to instrument Publish snapshots
if isempty(getenv('GRAPHICS_UPDATE_INSTRUMENTATION'))
    resetGraphics = onCleanup(@()setenv('GRAPHICS_UPDATE_INSTRUMENTATION'));
end
setenv('GRAPHICS_UPDATE_INSTRUMENTATION','true')
