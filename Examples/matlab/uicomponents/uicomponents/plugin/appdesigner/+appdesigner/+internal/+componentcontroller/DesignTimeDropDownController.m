classdef DesignTimeDropDownController < ...
	...
	methods
		function obj = DesignTimeDropDownController(component, parentController, proxyView)
			obj = obj@matlab.ui.control.internal.controller.DropDownController(component, parentController, proxyView);
			obj = obj@appdesigner.internal.componentcontroller.DesignTimeStateComponentController(component, parentController, proxyView);
