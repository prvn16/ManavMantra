classdef CircularGaugeAdapter < appdesigner.internal.componentadapterapi.VisualComponentAdapter
    ...
    % ---------------------------------------------------------------------
    methods
        function obj = CircularGaugeAdapter(varargin)
    ...
    methods(Static)        
        function className = getComponentType()
            className = 'matlab.ui.control.Gauge';
        end
