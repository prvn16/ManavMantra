classdef PushButtonAdapter < appdesigner.internal.componentadapterapi.VisualComponentAdapter
    % Adapter for Push Button
    ...
    % ---------------------------------------------------------------------
    methods
        function obj = PushButtonAdapter(varargin)
    ...
    methods(Static)
        function className = getComponentType()
            className = 'matlab.ui.control.Button';
        end
