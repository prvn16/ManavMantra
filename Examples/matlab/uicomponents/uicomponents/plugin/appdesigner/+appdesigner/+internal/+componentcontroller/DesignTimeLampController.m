classdef DesignTimeLampController < ...
        matlab.ui.control.internal.controller.LampController & ...
    ...
    methods
        function obj = DesignTimeLampController(component, parentController, proxyView)
            obj = obj@matlab.ui.control.internal.controller.LampController(component, parentController, proxyView);
