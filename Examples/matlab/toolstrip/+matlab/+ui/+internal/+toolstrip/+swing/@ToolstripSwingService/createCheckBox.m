function createCheckBox(this, widget_node)
    %% get widget peer node id
    widget_id = char(widget_node.getId());
    %% create swing widget
    jh = javaObjectEDT('com.mathworks.toolstrip.components.TSCheckBox');
    ...
    fcn = {@checkBoxToggledCallback, this, action_id};
...
function checkBoxToggledCallback(src, ~, this, action_id)
