...
BEGIN_DISPATCH_MAP(CMwsamp2Ctrl, COleControl)
	...
	DISP_PROPERTY_EX(CMwsamp2Ctrl, "Ret_IDispatch", GetRet_IDispatch, SetRet_IDispatch, VT_DISPATCH)
	DISP_PROPERTY_EX(CMwsamp2Ctrl, "RetVarDisp", GetRetVarDisp, SetRetVarDisp, VT_VARIANT)
	...
	DISP_FUNCTION(CMwsamp2Ctrl, "FireEventArgs", FireEventArgs, VT_EMPTY, VTS_NONE)
	DISP_FUNCTION(CMwsamp2Ctrl, "AddDouble", AddDouble, VT_R8, VTS_R8 VTS_R8)
	DISP_FUNCTION(CMwsamp2Ctrl, "FireMouseDownEvent", FireMouseDownEvent, VT_EMPTY, VTS_NONE)
	DISP_FUNCTION(CMwsamp2Ctrl, "ShowVariant", ShowVariant, VT_VARIANT, VTS_I2 VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT)
	DISP_FUNCTION(CMwsamp2Ctrl, "ReturnVTError", ReturnVTError, VT_VARIANT, VTS_NONE)
	DISP_FUNCTION(CMwsamp2Ctrl, "Fire_Double_Click", Fire_Double_Click, VT_EMPTY, VTS_NONE)
	DISP_FUNCTION(CMwsamp2Ctrl, "SetIDispatch", SetIDispatch, VT_BOOL, VTS_DISPATCH)
	DISP_FUNCTION(CMwsamp2Ctrl, "VariantOfTypeHandle", VariantOfTypeHandle, VT_BOOL, VTS_VARIANT)
	DISP_FUNCTION(CMwsamp2Ctrl, "RetErrorInfo", RetErrorInfo, VT_ERROR, VTS_NONE)
	//}}AFX_DISPATCH_MAP
...
BEGIN_EVENT_MAP(CMwsamp2Ctrl, COleControl)
	...
	EVENT_CUSTOM("Event_Args", FireEvent_Args, VTS_I2  VTS_I4  VTS_R8  VTS_BSTR  VTS_BOOL)
	EVENT_STOCK_CLICK()
...
BSTR CMwsamp2Ctrl::GetBSTR() 
{
    ...
    return (SysAllocString(L"sample string"));
}
...
void CMwsamp2Ctrl::FireEventArgs() 
{

    FireEvent_Args(3,35,5.5, "hello", 0);
}

double CMwsamp2Ctrl::AddDouble(double db1, double db2) 
{
...
void CMwsamp2Ctrl::FireMouseDownEvent() 
{
    FireMouseDown(3, 35, 99, 200);
}


VARIANT CMwsamp2Ctrl::ShowVariant(short arg1, const VARIANT FAR& var1, const VARIANT FAR& var2, const VARIANT FAR& var3, const VARIANT FAR& var4) 
{
    VARIANT vaResult;
    VariantInit(&vaResult);
	...
	default:
	case 1:
	    VariantCopy (&vaResult, (VARIANT *) &var1);
	    break;
	case 2:
	    VariantCopy (&vaResult, (VARIANT *) &var2);
	    break;
	case 3:
	    VariantCopy (&vaResult, (VARIANT *) &var3);
	    break;
	case 4:
	    VariantCopy (&vaResult, (VARIANT *) &var4);
	    break;
    }
...
VARIANT CMwsamp2Ctrl::ReturnVTError() 
{
    VARIANT vaResult;
    VariantInit(&vaResult);
    
    vaResult.vt     = VT_ERROR;
    vaResult.scode   = DISP_E_TYPEMISMATCH;
    

    return vaResult;
}

void CMwsamp2Ctrl::Fire_Double_Click() 
{
    FireDblClick();

}

LPDISPATCH CMwsamp2Ctrl::GetRet_IDispatch() 
{
...
void CMwsamp2Ctrl::SetRet_IDispatch(LPDISPATCH newValue) 
{
	// TODO: Add your property handler here
...
BOOL CMwsamp2Ctrl::SetIDispatch(LPDISPATCH arg1) 
{
	// TODO: Add your dispatch handler code here

    //check to see if incoming arg is IDispatch
...
BOOL CMwsamp2Ctrl::VariantOfTypeHandle(const VARIANT FAR& arg1) 
{
	// TODO: Add your dispatch handler code here
    BOOL ret = TRUE;
...
HRESULT CMwsamp2Ctrl::RetErrorInfo() 
{
	// TODO: Add your dispatch handler code here
	...
	_bstr_t bstr("mwsamp.mwsampctrl.2");
	pcerrinfo->SetSource(bstr);

	bstr = "sample error description from mwsamp2";
	pcerrinfo->SetDescription(bstr);

	bstr = "sample help file from mwsamp2";
	pcerrinfo->SetHelpFile(bstr);

	pcerrinfo->SetHelpContext(22);
...
void CMwsamp2Ctrl::OnSize(UINT nType, int cx, int cy) 
{
...
VARIANT CMwsamp2Ctrl::GetRetVarDisp() 
{
	VARIANT vaResult;
	VariantInit(&vaResult);

	vaResult.vt = VT_DISPATCH;
	vaResult.pdispVal = COleControl::GetIDispatch (TRUE);
...
void CMwsamp2Ctrl::SetRetVarDisp(const VARIANT FAR& newValue) 
{
	// TODO: Add your property handler here
