========================================================================
		ActiveX Control DLL : MWSAMP
========================================================================

ControlWizard has created this project for your MWSAMP ActiveX Control
...
that make up your MWSAMP ActiveX Control DLL.
...
MwsampCtl.h
	This file contains the declaration of the CMwsampCtrl C++ class.

MwsampCtl.cpp
	This file contains the implementation of the CMwsampCtrl C++ class.

MwsampPpg.h
	This file contains the declaration of the CMwsampPropPage C++ class.

MwsampPpg.cpp
	This file contains the implementation of the CMwsampPropPage C++ class.

MwsampCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CMwsampCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file mwsamp.rc.
