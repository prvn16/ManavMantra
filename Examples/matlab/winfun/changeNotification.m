...
%   added to the directory), you can place the following
%   command at the beginning of your matlabrc.m file to tell MATLAB to 
...
%   support UNIX-style directory timestamp updates, you can place the following 
%   command at the beginning of your matlabrc.m file to force MATLAB to 
%   detect changes by rereading the affected directories  
