...
%   arrays of character vectors. For a variable with multiple columns, its class's UNIQUE
...
%
%   UNIQUE does not take row names of tables into account.  Two rows that
%   have the same values but different names are considered equal. However,
%   when A and B are timetables, UNIQUE does take the row times into
