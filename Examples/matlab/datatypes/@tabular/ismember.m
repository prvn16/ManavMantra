...
%
%   ISMEMBER does not take row names of tables into account.  Two rows that
%   have the same values but different names are considered equal. However,
%   when A and B are timetables, ISMEMBER does take the row times into
%   account in determining equal rows.
%
