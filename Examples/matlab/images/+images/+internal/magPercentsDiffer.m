...
magPercent          = toPercent(mag);
candidateMagPercent = toPercent(candidateMag);
...
function percent = toPercent(fraction)
% Replaced from call to MagnificationComboBox.java
...
if(roundedPercent == percent)
    percent = percent;
elseif (roundedPercent>=10)
    percent = roundedPercent;
elseif (roundedPercent>=1)
