classdef MLCharArrayAdapter < internal.matlab.variableeditor.MLAdapter
    % MLCharArrayAdapter
    ...
    methods
        function storedValue = get.DataModel(this)
            if isempty(this.DataModel_I)
                this.DataModel = internal.matlab.variableeditor.MLCharArrayDataModel(...
    ...
    methods
        function storedValue = get.ViewModel(this)
            if isempty(this.ViewModel_I)
                this.ViewModel_I = internal.matlab.variableeditor.CharArrayViewModel(...
                    this.DataModel);
            end
    ...
    methods(Static)
        function c = getClassType()
            c = internal.matlab.variableeditor.MLCharArrayDataModel.ClassType;
        end
    end
end
