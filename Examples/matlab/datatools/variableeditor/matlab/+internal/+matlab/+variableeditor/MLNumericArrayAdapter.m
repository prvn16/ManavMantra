classdef MLNumericArrayAdapter < internal.matlab.variableeditor.MLAdapter
    ...
    methods
        function storedValue = get.DataModel(this)
            if isempty(this.DataModel_I)
                this.DataModel = internal.matlab.variableeditor.MLNumericArrayDataModel(this.Name, this.Workspace);
            end
