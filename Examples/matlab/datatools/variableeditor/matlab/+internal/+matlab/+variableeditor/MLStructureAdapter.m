classdef MLStructureAdapter < internal.matlab.variableeditor.MLAdapter
    %MLStructureAdapter
    ...
    methods
        function storedValue = get.DataModel(this)
            ...
            if isempty(this.DataModel_I)
                this.DataModel = internal.matlab.variableeditor.MLStructureDataModel(...
    ...
    methods(Static)
        function c = getClassType()
            c = internal.matlab.variableeditor.MLStructureDataModel.ClassType;
        end
    end
end
