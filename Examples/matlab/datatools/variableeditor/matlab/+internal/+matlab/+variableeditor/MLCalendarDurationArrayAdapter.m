classdef MLCalendarDurationArrayAdapter < internal.matlab.variableeditor.MLAdapter
    ...
    methods
        function storedValue = get.DataModel(this)
            if isempty(this.DataModel_I)
                this.DataModel = internal.matlab.variableeditor.MLCalendarDurationArrayDataModel(this.Name, this.Workspace);
            end
    ...
    methods
        function storedValue = get.ViewModel(this)
            if isempty(this.ViewModel_I)
                this.ViewModel_I = internal.matlab.variableeditor.CalendarDurationArrayViewModel(this.DataModel);
            end
    ...
    methods(Static)
        function c = getClassType()
            c = internal.matlab.variableeditor.MLCalendarDurationArrayDataModel.ClassType;
        end
    end
end
