classdef MLCellArrayAdapter < internal.matlab.variableeditor.MLAdapter
    %MLCellArrayAdapter
    ...
    methods
        function storedValue = get.DataModel(this)
            if isempty(this.DataModel_I)
                this.DataModel = internal.matlab.variableeditor.MLCellArrayDataModel(this.Name, this.Workspace);
            end
    ...
    methods
        function storedValue = get.ViewModel(this)
            if isempty(this.ViewModel_I)
                this.ViewModel_I = internal.matlab.variableeditor.CellArrayViewModel(this.DataModel);
            end
    ...
    methods(Static)
        function c = getClassType()
            c = internal.matlab.variableeditor.MLCellArrayDataModel.ClassType;
        end
    end
end
