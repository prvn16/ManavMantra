...
validateattributes(cbFunc,{'function_handle'},{'scalar'},'H5O.visit_by_name','iter_func');
...
[status, opdata_out] = H5ML.hdf5lib2('H5Ovisit_by_name',loc_id,obj_name,index_type,order,cbFunc,opdata_in,lapl_id);
