classdef VariableEditorTableAdapter < internal.matlab.variableeditor.MLAdapter
    %UITableAdapter
    ...
    methods
        function storedValue = get.DataModel(this)
            if isempty(this.DataModel_I) || ~isvalid(this.DataModel_I)
                this.DataModel = matlab.ui.internal.controller.uitable.UITableTableDataModel(this.Name, this.Workspace, this.viewInterface);
            end
    ...
    % Constructor
    methods
        function this = VariableEditorTableAdapter(viewInterface)
    ...
    methods (Access='public')
        ...
        function viewModel = getViewModel(this, document)
            ...
            if (isempty(this.ViewModel_I) || ...
                ~isa(this.ViewModel_I,'matlab.ui.internal.controller.uitable.PeerUITableTableViewModel')) ...
                && ~isempty(document) && ~isempty(document.PeerNode)
            
                delete(this.ViewModel_I);
                this.ViewModel_I = matlab.ui.internal.controller.uitable.PeerUITableTableViewModel(document.PeerNode, this);
            end
