classdef WebAppsFigurePlatformHost < matlab.ui.internal.controller.platformhost.FigurePlatformHost

    % FigurePlatformHost class containing the WebApps platform-specific functions for
    ...
    methods (Access = public)
        ...
        % constructor
        function this = WebAppsFigurePlatformHost(updatesFromClientImpl)
