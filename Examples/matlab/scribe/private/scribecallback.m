...
switch varargin{1}
    ...
    case 'clearaxes'
        cla(varargin{2});
    case 'copyfigure'
        % uimenufcn(varargin{2},'EditCopyFigure'); This is now dead code
end
...
for k=1:length(pnames)
    ...
    if strcmpi(p.AccessFlags.PublicSet,'on') && ...
        ...
        if ~isempty(find(strcmpi(pnames{k},cpnames), 1))
            % color properties
        ...
        elseif ~isempty(find(strcmpi(pnames{k},hsnames), 1))
            % head style
        ...
        elseif ~isempty(find(strcmpi(pnames{k},hbdnames), 1))
            % head back depth
        ...
        elseif ~isempty(find(strcmpi(pnames{k},hrpqnames), 1))
            % head rose pq
        ...
        elseif ~isempty(find(strcmpi(pnames{k},hhnnames), 1))
            % head hypocycloid n
        ...
        elseif ~isempty(find(strcmpi(pnames{k},hfnames), 1))
            % head filled
        ...
        elseif ~isempty(find(strcmpi(pnames{k},hfanames), 1))
            % head face alpha
        ...
        elseif ~isempty(find(strcmpi(pnames{k},henames), 1))
            % head edged
        ...
        elseif ~isempty(find(strcmpi(pnames{k},hlwnames), 1))
            % head line width
        ...
        elseif ~isempty(find(strcmpi(pnames{k},hlsnames), 1))
            % head line style
        ...
        elseif ~isempty(find(strcmpi(pnames{k},hwnames), 1))
            % head width
        ...
        elseif ~isempty(find(strcmpi(pnames{k},hlnames), 1))
            % head length
