classdef SuiteDetailsPart < matlab.unittest.internal.dom.ReportDocumentPart
    ...
    methods(Access=protected)
        ...
        function setupPart(docPart,testReportData)
            ...
            import matlab.unittest.internal.plugins.testreport.BaseFolderDetailsPart;
            ...
            headingPart = HeadingPart(1,docPart.Catalog.getString('SuiteDetailsHeading'));
            
            [baseFolders,~,ic] = unique(testReportData.TestSessionData.BaseFolders,'stable');
            baseFolderDetailsPartsCell = arrayfun(@(k) BaseFolderDetailsPart(...
                baseFolders{k},ic==k),...
                1:numel(baseFolders),'UniformOutput',false);
            
            docPart.ReportDocumentParts = [headingPart,...
                baseFolderDetailsPartsCell{:}];
