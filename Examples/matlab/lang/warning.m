...
%   WARNING(MESSAGE) displays the warning message MESSAGE, unless it has
%   been disabled (see the special identifier 'all' in "Controlling Warning
%   Message Display" below). When MESSAGE is the only input to WARNING,
%   WARNING displays it literally, without performing any substitutions
%   (see below) on the characters in MESSAGE.
%
%   WARNING(MESSAGE, A, B, ...) displays the formatted warning message
%   MESSAGE. The MESSAGE, specified as a character vector or string scalar,
...
%   appear in MESSAGE. Type HELP SPRINTF for more information on escape
%   sequences and format specifiers. WARNING performs these substitutions
%   on MESSAGE in all cases where more than one input is passed to WARNING.
%
%   WARNING(MSGID, MESSAGE, A, B, ...) displays the formatted warning
%   message MESSAGE as in the paragraph above, and tags the warning with
%   the message identifier MSGID. The identifier can be used to enable or
%   disable display of the identified warning (See "Controlling Warning
%   Message Display" below). A message identifier is a character vector or
...
%   display of any warning tagged with message identifier MSGID. (Use
...
%   identifier MSGID. This state information is returned in a structure S
