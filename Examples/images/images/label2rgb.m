...
%   image.  MAP can either be an n x 3 colormap matrix, a string or a
%   character vector containing the name of a colormap function (such as
%   'jet' or 'gray'), or a function handle of a colormap function (such as
%   @jet or @gray). LABEL2RGB evaluates MAP so that there is a different
%   color for each region in L. If MAP is not specified, 'jet' is used as
%   the default.
%
