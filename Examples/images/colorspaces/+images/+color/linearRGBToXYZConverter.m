function converter = linearRGBToXYZConverter(wp)
%LinearRGBToXYZConverter Color converter from Linear RGB to CIE 1931 XYZ
%
%   converter = images.color.linearRGBToXYZConverter
%   converter = images.color.linearRGBToXYZConverter(wp)
%
%   converter = images.color.linearRGBToXYZConverter returns a color
%   converter that converts linear RGB color values to CIE 1931 XYZ color
%   values.
%
%   converter = images.color.linearRGBToXYZConverter(wp) returns a color
