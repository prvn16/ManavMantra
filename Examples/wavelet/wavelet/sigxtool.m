...
%   $Revision: 1.11.4.20 $  $Date: 2013/08/23 23:45:10 $
...
switch option
    ...
    %-------------------------------------------%
        ...
        set(pop_swtdec,'Value',1);
        set(pop_swtdec,'String',int2str((1:swtpow)'),'Value',def_level);
    ...
    %------------------------------------------------------------------------%      
        ...
        if  strcmp(Mode_str(Mode_val),'For_SWT')
            ...
            if isequal(Signal_Length,2^nextpow2(Signal_Length))
                set(pus_extend,'Enable','off');
