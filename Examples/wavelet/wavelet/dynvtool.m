    ...
    case {'Install_V3','Install_V3_CB','create','create_V3'}
        ...
        switch option            
            ...
            case 'Install_V3_CB'
                ...
                ediStr = handle2str(handles.Edi_Center);
...
if bitget(flgTool,2)
    ...
    ediStr = handle2str(Edi_Center);
    cbFunc = [mfilename '(''edi_center'',' strNumFig ',' ediStr ');'];    
    ...
    cbFunc = [mfilename '(''center'',' strNumFig ',' ediStr];
