...
switch option
    ...
    case 'create'
        ...
        if isempty(fighelp)
            ...
            cba_close  = [mfilename '(''close'',gcbf);'];
            cba_btn_p1 = [mfilename '(''page_ud'',gcbf ,1);'];
            cba_btn_p2 = [mfilename '(''page_ud'',gcbf ,2);'];
            cba_btn_p3 = [mfilename '(''page_ud'',gcbf ,3);'];
