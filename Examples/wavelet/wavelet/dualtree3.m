...
%   coefficients, where L is the level of the transform. There are 28
%   wavelet subbands in the 3-D dual-tree transform at each level. The
...
%
%   [A,D] = DUALTREE3(...,'FilterLength',L) uses the orthogonal Hilbert
%   Q-shift filter pair with length L for levels two and higher. Valid
%   options for L are 6, 10, 14, 16, and 18. If unspecified, L defaults to
%   10.
%
...
if ~ismember(p.Results.FilterLength,validaf)
    error(message('Wavelet:FunctionInput:InvalidQshift'));
end
