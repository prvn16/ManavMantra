...
%   reconstruction.
% 
%   XREC = IDUALTREE3(...,'FilterLength',L) uses the Q-shift Hilbert
%   synthesis filter pair of length L. Valid options for L are 6, 10, 14,
%   16, or 18. If unspecified, L defaults to 10. The synthesis filter 
%   length used in IDUALTREE3 must match the analysis filter length in 
%   DUALTREE3.
%
