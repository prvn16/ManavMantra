function varargout = wtc_aswdr(option,typeSAVE,varargin)
...
switch numOPT
    ...
    case 1 , [varargout{1:nbout}] = wtc_aswdr_enc(varargin{:});
        %-- 'decode' --%
    case 2 , [varargout{1:nbout}] = wtc_aswdr_dec(typeSAVE,varargin{:});
        %--- 'save' ---%
    case 3 , [varargout{1:nbout}] = wtc_aswdr_save(typeSAVE,varargin{:});
        %--- 'load' ---%
    case 4 , [varargout{1:nbout}] = wtc_aswdr_load(typeSAVE,varargin{:});
end
...
%+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++%
    function Xrec = wtc_aswdr_dec(typeSAVE,WTC_Struct,stepFLAG)
...
%+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++%
    function fileSize = wtc_aswdr_save(typeSAVE,filename,WTC_Struct)
        ...
        % Begin Saving.
        %--------------
        codeID = wtcmngr('meth_ident',typeSAVE,'aswdr');
...
%+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++%
    function WTC_Struct = wtc_aswdr_load(typeSAVE,filename)
        % File settings.
        %---------------
        tmp_filename  = def_tmpfile(filename);
...
%+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++%
    function fileSize = wtc_aswdr_save_NEW(typeSAVE,filename,WTC_Struct) %#ok<DEFNU>
