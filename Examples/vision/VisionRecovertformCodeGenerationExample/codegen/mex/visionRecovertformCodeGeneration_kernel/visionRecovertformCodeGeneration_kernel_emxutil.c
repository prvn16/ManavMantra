...
static void emxFreeStruct_cell_wrap_26(const emlrtStack *sp, cell_wrap_26
  *pStruct);
...
{
  emxFree_real32_T(sp, &pStruct->pLocation);
  emxFree_real32_T(sp, &pStruct->pMetric);
  emxFree_real32_T(sp, &pStruct->pScale);
  emxFree_int8_T(sp, &pStruct->pSignOfLaplacian);
  emxFree_real32_T(sp, &pStruct->pOrientation);
}
  ...
  boolean_T doPush)
{
  ...
  emxInit_real32_T1(sp, &pStruct->pMetric, 1, srcLocation, doPush);
  emxInit_real32_T1(sp, &pStruct->pScale, 1, srcLocation, doPush);
  emxInit_int8_T(sp, &pStruct->pSignOfLaplacian, 1, srcLocation, doPush);
  emxInit_real32_T1(sp, &pStruct->pOrientation, 1, srcLocation, doPush);
}
...
void emxFreeMatrix_cell_wrap_26(const emlrtStack *sp, cell_wrap_26 pMatrix[2])
{
  int32_T i;
  for (i = 0; i < 2; i++) {
    emxFreeStruct_cell_wrap_26(sp, &pMatrix[i]);
  }
}
  ...
  const emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  int32_T i;
  for (i = 0; i < 2; i++) {
    emxInitStruct_cell_wrap_26(sp, &pMatrix[i], srcLocation, doPush);
  }
}
