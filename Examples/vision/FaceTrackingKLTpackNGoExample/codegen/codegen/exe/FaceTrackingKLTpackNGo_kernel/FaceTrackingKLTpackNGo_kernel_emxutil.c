 ...
 * File: FaceTrackingKLTpackNGo_kernel_emxutil.c
 *
...
static void emxFreeStruct_cell_wrap_59(cell_wrap_59 *pStruct);
static void emxInitStruct_cell_wrap_59(cell_wrap_59 *pStruct);

/* Function Definitions */

/*
 * Arguments    : cell_wrap_59 *pStruct
 * Return Type  : void
 */
static void emxFreeStruct_cell_wrap_59(cell_wrap_59 *pStruct)
{
 ...
 * Return Type  : void
 */
void emxEnsureCapacity_boolean_T2(emxArray_boolean_T *emxArray, int oldNumel)
{
  int newNumel;
  int i;
  void *newData;
...
/*
 * Arguments    : cell_wrap_59 pMatrix[2]
 * Return Type  : void
 */
void emxFreeMatrix_cell_wrap_59(cell_wrap_59 pMatrix[2])
{
  int i;
  for (i = 0; i < 2; i++) {
    emxFreeStruct_cell_wrap_59(&pMatrix[i]);
  }
}
 ...
 * Return Type  : void
 */
void emxInitMatrix_cell_wrap_59(cell_wrap_59 pMatrix[2])
{
  int i;
  for (i = 0; i < 2; i++) {
    emxInitStruct_cell_wrap_59(&pMatrix[i]);
  }
}
 ...
 * Return Type  : void
 */
void emxInit_boolean_T2(emxArray_boolean_T **pEmxArray, int numDimensions)
{
  emxArray_boolean_T *emxArray;
  int i;
  *pEmxArray = (emxArray_boolean_T *)malloc(sizeof(emxArray_boolean_T));
...
/*
 * File trailer for FaceTrackingKLTpackNGo_kernel_emxutil.c
 *
 * [EOF]
 */
