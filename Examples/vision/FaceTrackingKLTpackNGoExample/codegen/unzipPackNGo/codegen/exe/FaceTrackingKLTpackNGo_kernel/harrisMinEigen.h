...
extern void parseInputs(const float varargin_2_data[], const int
  varargin_2_size[2], float *params_MinQuality, double *params_FilterSize,
  boolean_T *params_usingROI, int params_ROI_data[], int params_ROI_size[2]);
